...
namespace VoucherApplication
{
    ...
    public partial class Form1 : MetroFramework.Forms.MetroForm
    {
        ...
        public bool data_SendStart = false;
        ...
        private void RecieveMessage()
        {
            while (true)
            {
                try
                {
                    ...
                    //Data Send
                    string[] splitedMessage_string = message.Split(';');
                    Console.WriteLine(splitedMessage_string[0]);
                    



                    foreach(var item in splitedMessage_string)
                    {
                        string[] splitedMessage = item.Split(',');
                        string reciver = splitedMessage[item].Substring(0, 2);
                        ...
                        switch (reciver)
                        {
                            case "<P":
                                ...
                                sendData = $"{message},{preUnixMilliseconds};";
